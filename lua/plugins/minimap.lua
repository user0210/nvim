...
vim.g.minimap_block_filetypes = {'tagbar', 'fzf', 'telescope', 'NvimTree', 'undotree'}
vim.g.minimap_block_buftypes = {'nofile', 'nowrite', 'quickfix', 'terminal', 'prompt', 'NvimTree', 'undotree'}
