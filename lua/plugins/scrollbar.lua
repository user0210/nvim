...
vim.api.nvim_set_hl(0, "ScrollbarErrorHandle", 		{ bg = colors.base01,	fg = colors.base08a })
vim.api.nvim_set_hl(0, "ScrollbarWarn", 			{ bg = colors.base00,	fg = colors.base09b })
vim.api.nvim_set_hl(0, "ScrollbarWarnHandle", 		{ bg = colors.base01,	fg = colors.base09a })
vim.api.nvim_set_hl(0, "ScrollbarSearch", 			{ bg = colors.base00,	fg = colors.base0Ab })
vim.api.nvim_set_hl(0, "ScrollbarSearchHandle", 	{ bg = colors.base01,	fg = colors.base0Aa })
vim.api.nvim_set_hl(0, "ScrollbarInfo", 			{ bg = colors.base00,	fg = colors.base0Cb })
vim.api.nvim_set_hl(0, "ScrollbarInfoHandle", 		{ bg = colors.base01,	fg = colors.base0Ca })
vim.api.nvim_set_hl(0, "ScrollbarHint", 			{ bg = colors.base00,	fg = colors.base0Fb })
vim.api.nvim_set_hl(0, "ScrollbarHintHandle", 		{ bg = colors.base01,	fg = colors.base0Fa })
vim.api.nvim_set_hl(0, "ScrollbarMisc", 			{ bg = colors.base00,	fg = colors.base03 })
vim.api.nvim_set_hl(0, "ScrollbarMiscHandle", 		{ bg = colors.base01,	fg = colors.base04 })
vim.api.nvim_set_hl(0, "ScrollbarGitAdd", 			{ bg = colors.base00,	fg = colors.base0Bb })
vim.api.nvim_set_hl(0, "ScrollbarGitAddHandle", 	{ bg = colors.base01,	fg = colors.base0Ba })
vim.api.nvim_set_hl(0, "ScrollbarGitChange", 		{ bg = colors.base00,	fg = colors.base0Db })
vim.api.nvim_set_hl(0, "ScrollbarGitChangeHandle", 	{ bg = colors.base01,	fg = colors.base0Da })
vim.api.nvim_set_hl(0, "ScrollbarGitDelete", 		{ bg = colors.base00,	fg = colors.base0Fb })
vim.api.nvim_set_hl(0, "ScrollbarGitDeleteHandle", 	{ bg = colors.base01,	fg = colors.base0Fa })
